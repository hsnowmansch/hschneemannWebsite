...
- [x] Hero-Bereich visuell aufwerten (klarer Key-Visual, stärkerer erster Eindruck, weniger Text auf einen Blick).
- [x] Projektbereich als visuelle Karten mit Fokus-Highlights umbauen (statt nur lange Textlisten).
- [x] Farb- und Typografie-System modernisieren (hellere, freundlichere Anmutung, bessere Kontraste, weniger „dunkel und dicht“).
- [x] Micro-Interactions ergänzen (dezente Hover-/Reveal-Effekte, ohne aufdringliche Animationen).
- [x] Content straffen: redundante Absätze kürzen und Lesefluss verbessern.
