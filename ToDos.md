...
- [ ] Micro-Interactions ergänzen (dezente Hover-/Reveal-Effekte, ohne aufdringliche Animationen).
- [ ] Content straffen: redundante Absätze kürzen und Lesefluss verbessern.
